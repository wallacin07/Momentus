        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div className="md:col-span-1">
            ...
            <p className="text-muted-foreground mb-6">
              Plataforma completa para gestão e organização de eventos que eleva o nível do seu trabalho como cerimonialista.
            </p>
          ...
          <div className="md:col-span-1">
            <h3 className="font-playfair text-lg font-semibold mb-4">Plataforma</h3>
            <ul className="space-y-2">
              <li><a href="#features" className="text-muted-foreground hover:text-primary">Recursos</a></li>
              <li><a href="#how-it-works" className="text-muted-foreground hover:text-primary">Como funciona</a></li>
          ...
          <div className="md:col-span-1">
            <h3 className="font-playfair text-lg font-semibold mb-4">Suporte</h3>
            <ul className="space-y-2">
              <li><a href="#" className="text-muted-foreground hover:text-primary">Central de Ajuda</a></li>
              <li><a href="#" className="text-muted-foreground hover:text-primary">Tutoriais</a></li>
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-muted-foreground mb-4">Inscreva-se para receber dicas e novidades para cerimonialistas.</p>
        ...
        <div className="border-t border-primary/10 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-muted-foreground mb-4 md:mb-0">
              © {new Date().getFullYear()} Ceremonie. Todos os direitos reservados.
            </p>
